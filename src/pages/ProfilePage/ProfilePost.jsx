import { Avatar,GridItem, Flex, Text, Image, 
  useDisclosure, Modal, ModalOverlay, ModalContent, 
  ModalBody, ModalCloseButton, Divider, VStack, Button } from "@chakra-ui/react"
import {AiFillHeart} from 'react-icons/ai'
import {FaComment} from 'react-icons/fa'
import {MdDelete} from 'react-icons/md'
import Comments from "../../components/Comments/Comments"
import FeedPostFooter from "../../components/FeedPosts/FeedPostFooter"
...
const ProfilePost = ({post}) => {
  ...
  >
    ...
    <Image src ={post.imageURL} alt ="post image" w={"100%"} h={"100%"} objectFit={"cover"}/>
  </GridItem>
    ...
    <ModalContent>
      ...
      > 
        <Flex gap={4} w={{base: "90%", sm:"70%", md: "full"}} mx="auto" maxH={"90vh"} minH={"50vh"}>
          ...
          <Flex flex = {1} flexDirection = {"column"} px={10} display={{base: "none", md:"flex"}}>
            <Flex alignItems={"center"} justifyContent={"space-between"}>
                <Flex alignItems={"center"} gap ={4}>
                  <Avatar src = {userProfile.profilePicURL} size={"sm"} name="SoftClaws"/>
                ...
                size={"small"}
                bg={"transparent"}
                _hover = {{bg: "whiteAlpha.300", color: "red.600"}} borderRadius={4} p={1} isLoading={isDeleting} onClick={handleDeletePost}>
          ...
          <FeedPostFooter isProfilePage={true} post={post}/>
